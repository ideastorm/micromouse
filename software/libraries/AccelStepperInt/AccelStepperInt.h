...
public:
    ...
    AccelStepperInt(uint8_t interface = AccelStepperInt::FULL4WIRE, uint8_t pin1 = 2, uint8_t pin2 = 3, uint8_t pin3 = 4, uint8_t pin4 = 5, bool enable = true);
...
private:
    ...
    volatile unsigned long _curTime=0;
